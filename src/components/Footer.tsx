      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-black text-[#26A69A] uppercase">Sonora Zen</h3>
            <p className="text-sm">Votre allié pour un sommeil profond.</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center gap-2"><Mail size={16}/> contact@sonora-zen.com</li>
              <li className="flex items-center gap-2"><Phone size={16}/> +33 (0)1 23 45 67 89</li>
            </ul>
          </div>
