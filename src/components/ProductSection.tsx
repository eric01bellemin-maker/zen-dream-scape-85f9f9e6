...
<button className="w-full md:w-auto px-10 py-7 bg-slate-900 hover:bg-emerald-700 text-white text-lg rounded-2xl shadow-lg transition-all transform hover:-translate-y-1 flex items-center justify-center">
