  ...
  return (
    <section id="hero" className="relative bg-white pt-32 pb-16">
      <div className="container mx-auto px-4 text-center">
        ...
        {/* Ton Image de Bannière Principale (background-final.jpg) */}
        <div className="relative max-w-5xl mx-auto aspect-[16/10] rounded-3xl overflow-hidden shadow-2xl mb-20 border border-gray-100 bg-gray-50">
          <img 
            src="/background-final.jpg" 
            alt="Femme dormant paisiblement" 
