      ...
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="relative max-w-5xl mx-auto aspect-[16/9] rounded-3xl overflow-hidden shadow-2xl mb-20 border border-gray-100 bg-gray-50">
          ...
          <div className="absolute inset-0 bg-black/10 flex items-center justify-center">
            {/* Overlay léger pour l'esthétique */}
          </div>
        </div>

        {/* Tes 4 Univers (Images du bas) */}
        <h3 className="text-2xl font-bold mb-10 tracking-tight text-black uppercase">Nos Univers</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
          {[
            ...
            <div key={index} className="group relative rounded-2xl overflow-hidden aspect-[4/5] shadow-md border border-gray-100">
              <img 
                src={item.src} 
                alt={item.title} 
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex items-end p-6">
                <p className="text-white text-lg font-semibold tracking-wide uppercase">{item.title}</p>
              </div>
            </div>
          ))}
        </div>
