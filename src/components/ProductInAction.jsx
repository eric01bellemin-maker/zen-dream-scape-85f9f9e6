    ...
    <section className="py-24 bg-white">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-20">
          <h2 className="text-4xl font-bold text-slate-800 mb-4">Le Sommeil, Réinventé Partout</h2>
              ...
              <div className="md:w-1/2">
                <div className="relative group">
                  <img 
                    src={feature.image} 
                    alt={feature.alt} 
                    className="rounded-[40px] shadow-2xl transition-transform duration-500 group-hover:scale-105 border-4 border-[#f0f9ff]"
                  />
                </div>
              </div>
