  ...
  return (
    <div className="min-h-screen bg-[#0f172a] text-white flex flex-col items-center pt-20 md:justify-center p-6">
      ...
      <div className="max-w-5xl w-full">
        ...
        {/* LE LECTEUR VIDÉO (C'est ici que la magie opère) */}
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
          <div className="p-4 bg-white/5 rounded-xl border border-white/10">
            <p className="text-[#26A69A] font-bold">Étape 1</p>
            <p className="text-sm">Placez le Sonora Zen sous votre oreiller</p>
          </div>
          <div className="p-4 bg-white/5 rounded-xl border border-white/10">
            <p className="text-[#26A69A] font-bold">Étape 2</p>
            <p className="text-sm">Fermez les yeux et respirez calmement</p>
          </div>
          <div className="p-4 bg-white/5 rounded-xl border border-white/10">
            <p className="text-[#26A69A] font-bold">Étape 3</p>
            <p className="text-sm">Laissez les vibrations vous apaiser</p>
          </div>
        </div>
      </div>
    </div>
